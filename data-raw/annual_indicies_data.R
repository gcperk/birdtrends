## code to prepare `annual_indicies_data` dataset goes here

## This script was written by Adam Smith (Adam.Smith@ec.gc.ca) and edited by Genevieve Perkins
## March 22nd 2024
...
annual_indicies_data = input_option_1
